...
class ModelDownloader(private val context: Context) {
    companion object {
        private const val QWEN_URL = "https://huggingface.co/ggml-org/Qwen3-0.6B-GGUF/resolve/main/Qwen3-0.6B-Q4_0.gguf?download=true"
        private const val WHISPER_URL = "https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-tiny.bin?download=true"
        private const val MIN_QWEN_BYTES = 300_000_000L
    ...
    private suspend fun download(url: String, target: File, minimumBytes: Long): Result<String> = withContext(Dispatchers.IO) {
        ...
        runCatching {
            ...
            val connection = (URL(url).openConnection() as HttpURLConnection).apply {
                connectTimeout = 20_000; readTimeout = 120_000; instanceFollowRedirects = true; requestMethod = "GET"
            }
            try {
                connection.connect()
